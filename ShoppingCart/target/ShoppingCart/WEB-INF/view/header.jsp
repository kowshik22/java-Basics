							...
							<div class="sap_tabs">	
								<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
									...
									<div class="tab-2 resp-tab-content" aria-labelledby="tab_item-1">
										...
										<script src="<C:url value="Resource/js/easyResponsiveTabs.js"/>" type="text/javascript"></script>
		...
		<div class="container">
			...
			<div class="cart box_1">
				<a href="checkout">
					...
					<Resource/images2 src="Resource/images2/bag.png" alt="" />
				</a>
								...
								<div class="row">
									...
									<div class="col-sm-4">
										<div class="w3ls_products_pos">
											<h4>50%<i>Off/-</i></h4>
											<img src="Resource/images2/1.jpg" alt=" " class="Resource/images2-responsive" />
										</div>
									</div>
									<div class="clearfix"></div>
								</div>
