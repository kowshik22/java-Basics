...
<title>Women's Fashion a Ecommerce Online Shopping Category Flat Bootstrap Responsive Website Template | Shorts & Skirts :: w3layouts</title>
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=1">
				...
				<div class="col-md-4 w3ls_dresses_grid_left">
					...
					<div class="w3ls_dresses_grid_left_grid">
						<div class="dresses_img_hover">
							<img src="Resource/images2/57.jpg" alt=" " class="img-responsive" />
				...
				<div class="col-md-8 w3ls_dresses_grid_right">
					<div class="col-md-6 w3ls_dresses_grid_right_left">
						<div class="w3ls_dresses_grid_right_grid1">
							<img src="Resource/images2/58.jpg" alt=" " class="img-responsive" />
					...
					<div class="col-md-6 w3ls_dresses_grid_right_left">
						<div class="w3ls_dresses_grid_right_grid1">
							<img src="Resource/images2/59.jpg" alt=" " class="img-responsive" />
