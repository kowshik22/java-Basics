		...
		<div class="container">
			<div class="col-md-4 single-left">
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="Resource/images2/a.jpg">
							<div class="thumb-image"> <img src="Resource/images2/a.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="Resource/images2/b.jpg">
							 <div class="thumb-image"> <img src="Resource/images2/b.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="Resource/images2/c.jpg">
						   <div class="thumb-image"> <img src="Resource/images2/c.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li> 
					</ul>
				</div>
				<!-- flixslider -->
					<script defer src="<C:url value="Resource/js/jquery.flexslider.js"/>"></script>
					<link rel="stylesheet" href="<C:url value="Resourcecss/flexslider.css"/>" type="text/css" media="screen" />
					<script>
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left dresses_grid">
							...
							<h5><a href="single">Black Short</a></h5>
							<div class="simpleCart_shelfItem">
