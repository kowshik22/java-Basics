					...
					<div class="w3ls_dresses_grid_left_grid">
						...
						<div class="w3ls_dresses_grid_left_grid_sub">
								...
								<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
								   <div class="panel-body panel_text">
									<ul>
										...
										<li><a href="sandals">Heals</a></li>
										<li><a href="sandals">Shirts</a></li>
									</ul>
								  </div>
								</div>
							  </div>
							...
							<ul class="panel_bottom">
								...
								<li><a href="dresses">New In Clothing</a></li>
								<li><a href="sandals">New In Shoes</a></li>
				...
				<div class="col-md-8 w3ls_dresses_grid_right">
					<div class="col-md-6 w3ls_dresses_grid_right_left">
						<div class="w3ls_dresses_grid_right_grid1">
							<img src="Resource/images2/67.jpg" alt=" " class="img-responsive" />
					...
					<div class="col-md-6 w3ls_dresses_grid_right_left">
						<div class="w3ls_dresses_grid_right_grid1">
							<img src="Resource/images2/68.jpg" alt=" " class="img-responsive" />
					...
					<div class="w3ls_dresses_grid_right_grid3">
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div class="agile_ecommerce_tab_left dresses_grid">
								<div class="hs-wrapper hs-wrapper2">
									<img src="Resource/images2/w1.jpg" alt=" " class="img-responsive" />
									<img src="Resource/images2/w2.jpg" alt=" " class="img-responsive" />
									<img src="Resource/images2/w3.jpg" alt=" " class="img-responsive" />
									<img src="Resource/images2/w4.jpg" alt=" " class="img-responsive" />
									<img src="Resource/images2/w5.jpg" alt=" " class="img-responsive" />
									<img src="Resource/images2/w6.jpg" alt=" " class="img-responsive" />
									<img src="Resource/images2/w7.jpg" alt=" " class="img-responsive" />
									<img src="Resource/images2/w8.jpg" alt=" " class="img-responsive" />
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div class="agile_ecommerce_tab_left dresses_grid">
								<div class="hs-wrapper hs-wrapper2">
									...
									<img src="Resource/images2/w7.jpg" alt=" " class="img-responsive" />
									<img src="Resource/images2/w8.jpg" alt=" " class="img-responsive" />
									<img src="Resource/images2/w9.jpg" alt=" " class="img-responsive" />
									<div class="w3_hs_bottom w3_hs_bottom_sub1">
										<ul>
											<li>
												<a href="#" data-toggle="modal" data-target="#myModal7"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div class="agile_ecommerce_tab_left dresses_grid">
								...
								<h5><a href="salwars">Black Solid Salwar</a></h5>
								<div class="simpleCart_shelfItem">
					...
					<div class="w3ls_dresses_grid_right_grid3">
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div class="agile_ecommerce_tab_left dresses_grid">
								...
								<h5><a href="salwars">Dhoti Salwar</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div class="agile_ecommerce_tab_left dresses_grid">
								...
								<h5><a href="single">Green Solid Salwar</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div class="agile_ecommerce_tab_left dresses_grid">
								...
								<h5><a href="single">Navy Blue Salwar</a></h5>
								<div class="simpleCart_shelfItem">
					...
					<div class="w3ls_dresses_grid_right_grid3">
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div class="agile_ecommerce_tab_left dresses_grid">
								...
								<h5><a href="single">Blue Solid Patiala</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div class="agile_ecommerce_tab_left dresses_grid">
								...
								<h5><a href="single">Peach Solid Patiala</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div class="agile_ecommerce_tab_left dresses_grid">
								...
								<h5><a href="single">Black Dhoti Pant</a></h5>
								<div class="simpleCart_shelfItem">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<section>
					<div class="modal-body">
						<div class="col-md-5 modal_body_left">
							<img src="Resource/images2/66.jpg" alt=" " class="img-responsive" />
						</div>
						<div class="col-md-7 modal_body_right">
					...
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left dresses_grid">
							<div class="hs-wrapper hs-wrapper3">
								<img src="Resource/images2/51.jpg" alt=" " class="img-responsive" />
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left dresses_grid">
							...
							<h5><a href="single">Black Shorts</a></h5>
							<div class="simpleCart_shelfItem">
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left dresses_grid">
							...
							<h5><a href="single">White Skirts</a></h5>
							<div class="simpleCart_shelfItem">
